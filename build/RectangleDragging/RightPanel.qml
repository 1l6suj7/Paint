...
Item {
    ...
    function updateLayerList() {
        layersList.model = GraphicLogic.getLayersList();
        root.update();
    }
    ...
    Item {
        ...
        ListView {
            ...
            model: GraphicLogic.getLayersList()
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            TextField {
                                ...
                                property int layerIndex: modelData.index
                                ...
                                onEditingFinished: {
                                    console.log("Editing finished - text:", text, "saved:", savedText, "index:", layerIndex);
                                    handleTextChange();
                                }
                                
                                onActiveFocusChanged: {
                                    console.log("Focus changed:", activeFocus, "text:", text);
                                    if (activeFocus) {
                                        savedText = text;
                                        selectAll();
                                    } else {
                                ...
                                function handleTextChange() {
                                    if (text.trim() === "") {
                                        ...
                                        console.log("Updating graphic name:", layerIndex, "->", text);
                                        GraphicLogic.setGraphicName(layerIndex, text);
                                        savedText = text;
                                        root.updateLayerList();
                                    }
                                }

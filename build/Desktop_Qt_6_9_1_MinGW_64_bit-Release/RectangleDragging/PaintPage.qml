...
Item {
    ...
    GCanvas {
        ...
        onUpdate: {
            root.drawMode = drawingCanvas.drawMode;
            root.selectedGraphicIndex = drawingCanvas.selectedGraphicIndex;
        }

        onRequestLayerPanel: rightPanel.updateLayerList();

        onRequestPropertyPanel: rightPanel.updatePropertyList();
    }
    ...
    RightPanel {
        ...
        onUpdate: {
            root.drawMode = rightPanel.drawMode;
            root.selectedGraphicIndex = rightPanel.selectedGraphicIndex;
        }

        onRequestCanvas: drawingCanvas.requestPaint();
    }
}
